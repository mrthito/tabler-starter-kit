<x-app-layout :page="__('Edit Role')" layout="admin">

    <x-slot name="pretitle">{{ __('Roles') }}</x-slot>
    <x-slot name="subtitle">{{ __('Edit Role') }}</x-slot>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('guard') is-invalid @enderror" name="guard"
                                        ...
                                        <option value="admin"
                                            {{ old('guard', $role->guard) == 'admin' ? 'selected' : '' }}>
                                            {{ __('Admin') }}</option>
                                        <option value="web"
                                            {{ old('guard', $role->guard) == 'web' ? 'selected' : '' }}>
                                            {{ __('Web') }}</option>
                                    </select>
                            ...
                            <div class="card-body">
                                <div class="permissions-container">
                                    @php
                                        ...
                                        // Get role permissions from database or old input
                                                        ...
                                                        <div class="col-md-6 col-lg-4 mb-2">
                                                            <label class="form-check form-switch">
                                                                <input class="form-check-input permission-checkbox"
                                                                    ...
                                                                    data-group="{{ $groupKey }}"
                                                                    {{ in_array($permissionValue, $rolePermissions) ? 'checked' : '' }}>
