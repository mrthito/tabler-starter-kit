<x-app-layout :page="__('Edit Plan')" layout="admin">

    <x-slot name="pretitle">{{ __('Plans') }}</x-slot>
    <x-slot name="subtitle">{{ __('Edit Plan') }}</x-slot>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" max="100"
                                        ...
                                        value="{{ old('yearly_discount_percentage', $plan->yearly_discount_percentage) }}"
                                        placeholder="0">
                                    <small
                                        ...
                                        @foreach ($features as $index => $feature)
                                            <div class="input-group mb-2 feature-item">
                                                ...
                                                <button type="button" class="btn btn-outline-danger remove-feature"
                                                    {{ $loop->first && count($features) == 1 ? 'disabled' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('plan_type') is-invalid @enderror"
                                        ...
                                        <option value="paid"
                                            {{ old('plan_type', $plan->plan_type) == 'paid' ? 'selected' : '' }}>
                                            {{ __('Paid') }}</option>
                                        <option value="free"
                                            {{ old('plan_type', $plan->plan_type) == 'free' ? 'selected' : '' }}>
                                            {{ __('Free') }}</option>
                                        <option value="enterprise"
                                            {{ old('plan_type', $plan->plan_type) == 'enterprise' ? 'selected' : '' }}>
                                            {{ __('Enterprise') }}</option>
                                        <option value="custom"
                                            {{ old('plan_type', $plan->plan_type) == 'custom' ? 'selected' : '' }}>
                                            {{ __('Custom') }}</option>
                                    </select>
