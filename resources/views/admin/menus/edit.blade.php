<x-app-layout :page="__('Edit Menu')" layout="admin">

    <x-slot name="pretitle">{{ __('Appearance') }}</x-slot>
    <x-slot name="subtitle">{{ __('Edit Menu') }}</x-slot>

    <x-slot name="actions">
        <a href="{{ route('admin.appearance.menus.show', $menu) }}" class="btn btn-secondary">
            <i class="ti ti-menu-2 icon icon-1"></i>
            {{ __('Manage Items') }}
        </a>
    ...
    <div class="row row-cards">
        <div class="col-12">
            <form action="{{ route('admin.appearance.menus.update', $menu) }}" method="POST">
                @csrf
                @method('PATCH')
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" value="{{ old('title', $menu->title) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('location') is-invalid @enderror"
                                        name="location" value="{{ old('location', $menu->location) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="3"
                                        placeholder="{{ __('Optional description for this menu.') }}">{{ old('description', $menu->description) }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror"
                                        name="order" value="{{ old('order', $menu->order) }}" min="0">
                                    <small class="form-hint">
