<x-app-layout :page="__('Edit Transaction Category')" layout="admin">

    <x-slot name="pretitle">{{ __('Transaction Categories') }}</x-slot>
    <x-slot name="subtitle">{{ __('Edit Transaction Category') }}</x-slot>
    ...
    <div class="row row-cards">
        <div class="col-12">
            <form action="{{ route('admin.transaction-categories.update', $transactionCategory) }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" value="{{ old('name', $transactionCategory->name) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                        name="slug" value="{{ old('slug', $transactionCategory->slug) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="4"
                                        placeholder="{{ __('Enter category description (optional)') }}">{{ old('description', $transactionCategory->description) }}</textarea>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" name="type"
                                        required>
                                        <option value="income"
                                            {{ old('type', $transactionCategory->type) == 'income' ? 'selected' : '' }}>
                                            {{ __('Income') }}</option>
                                        <option value="expense"
                                            {{ old('type', $transactionCategory->type) == 'expense' ? 'selected' : '' }}>
                                            {{ __('Expense') }}</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="color"
                                        ...
                                        name="color"
                                        value="{{ old('color', $transactionCategory->color ?: '#066fd1') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('icon') is-invalid @enderror"
                                        name="icon" value="{{ old('icon', $transactionCategory->icon) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                        name="sort_order"
                                        value="{{ old('sort_order', $transactionCategory->sort_order) }}"
                                        placeholder="0">
                                ...
                                <div class="mb-3">
                                    <label class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status" value="1"
                                            {{ old('status', $transactionCategory->status) ? 'checked' : '' }}>
