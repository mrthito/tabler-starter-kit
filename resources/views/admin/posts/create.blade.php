<x-app-layout :page="__('Create Post')" layout="admin">

    <x-slot name="pretitle">{{ __('Posts') }}</x-slot>
    <x-slot name="subtitle">{{ __('Create Post') }}</x-slot>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="15"
                                        placeholder="{{ __('Enter post content') }}" required>{{ old('content') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt') is-invalid @enderror" name="excerpt" rows="3"
                                        placeholder="{{ __('Enter post excerpt (optional)') }}">{{ old('excerpt') }}</textarea>
                                    <small
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('post_type') is-invalid @enderror"
                                        name="post_type">
                                        <option value="blog"
                                            {{ old('post_type', 'blog') == 'blog' ? 'selected' : '' }}>
                                            {{ __('Blog') }}</option>
                                        <option value="news" {{ old('post_type') == 'news' ? 'selected' : '' }}>
                                            {{ __('News') }}</option>
                                    </select>
