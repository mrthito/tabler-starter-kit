<x-app-layout :page="__('Dashboard')" layout="admin">
    <div class="row row-deck row-cards">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto lh-1">
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-secondary" id="sales-dropdown"
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <a class="dropdown-item active" href="#"
                                                        aria-current="true">Last 7 days</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-auto lh-1">
                                            <div class="dropdown">
                                                <a class="dropdown-toggle text-secondary" id="revenue-dropdown"
                                                    href="#" data-bs-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="text-truncate"><strong>Sunny Airey</strong>
                                                                ...
                                                                <strong>Inspirations</strong>.</div>
                                                            <div class="text-secondary">2 days ago</div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-10">
                                            ...
                                            <div class="markdown">
                                                ...
                                                <a href="https://tabler.io/icons" target="_blank"
                                                    rel="noopener">Tabler Icons Website</a>, download any of the 5880
                                                icons in SVG, PNG
                        ...
                        <div class="col-md-6 col-lg-4">
                            <a href="https://github.com/sponsors/codecalm" class="card border-primary"
                                target="_blank" rel="noopener" aria-label="Sponsor Tabler!"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 480 373"
                                    ...
                                    <path fill="#8D5548" stroke="#000" stroke-miterlimit="10"
                                        stroke-opacity=".2" stroke-width=".372"
