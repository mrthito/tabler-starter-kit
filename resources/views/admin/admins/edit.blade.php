            ...
            <form action="{{ route('admin.admins.update', $admin) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                                name="last_name" value="{{ old('last_name', $admin->last_name) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('role_id') is-invalid @enderror" name="role_id"
                                        ...
                                        @foreach (\App\Models\Role::where('guard', 'admin')->where('status', 1)->get() as $role)
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('Admin Status') }}</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <small class="text-muted">
                                    {{ __('Active admins can log in and access their assigned permissions.') }}
                                </small>
                            </div>
                        </div>
                                ...
                                @if ($admin->avatar)
                                    <div class="mb-3">
                                        <img src="{{ $admin->avatar }}"
                                            alt="{{ $admin->name }}" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                @endif
                                <div class="mb-3">
                                    <input type="file"
