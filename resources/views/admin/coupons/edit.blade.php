<x-app-layout :page="__('Edit Coupon')" layout="admin">

    <x-slot name="pretitle">{{ __('Coupons') }}</x-slot>
    <x-slot name="subtitle">{{ __('Edit Coupon') }}</x-slot>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="3"
                                        placeholder="{{ __('Enter coupon description') }}">{{ old('description', $coupon->description) }}</textarea>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" max="100"
                                        ...
                                        value="{{ old('value', $coupon->value) }}" placeholder="0.00" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('applicable_to') is-invalid @enderror"
                                        ...
                                        <option value="all"
                                            ...
                                            {{ __('All Plans') }}</option>
                                        <option value="plans"
                                            {{ old('applicable_to', $coupon->applicable_to) == 'plans' ? 'selected' : '' }}>
                                            {{ __('All Plans (explicit)') }}</option>
                                        <option value="specific_plans"
                                            {{ old('applicable_to', $coupon->applicable_to) == 'specific_plans' ? 'selected' : '' }}>
                                        ...
                                        @foreach ($plans as $plan)
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" name="plan_ids[]"
                                                    ...
                                                    {{ in_array($plan->id, old('plan_ids', $coupon->plan_ids ?? [])) ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        name="sort_order" value="{{ old('sort_order', $coupon->sort_order) }}"
                                        placeholder="0">
