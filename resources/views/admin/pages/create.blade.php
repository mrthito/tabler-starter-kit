<x-app-layout :page="__('Create Page')" layout="admin">

    <x-slot name="pretitle">{{ __('Pages') }}</x-slot>
    <x-slot name="subtitle">{{ __('Create Page') }}</x-slot>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="15"
                                        placeholder="{{ __('Enter page content') }}" required>{{ old('content') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt') is-invalid @enderror" name="excerpt" rows="3"
                                        placeholder="{{ __('Enter page excerpt (optional)') }}">{{ old('excerpt') }}</textarea>
                                    <small
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('og_description') is-invalid @enderror" name="og_description" rows="2"
                                                        placeholder="{{ __('Leave blank to use meta description') }}" maxlength="200">{{ old('og_description') }}</textarea>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('twitter_description') is-invalid @enderror" name="twitter_description"
                                                        rows="2" placeholder="{{ __('Leave blank to use meta description') }}" maxlength="200">{{ old('twitter_description') }}</textarea>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="twitter_image" value="{{ old('twitter_image') }}"
                                                        placeholder="{{ __('Leave blank to use featured image') }}">
