<x-app-layout :page="__('Edit Page')" layout="admin">

    <x-slot name="pretitle">{{ __('Pages') }}</x-slot>
    <x-slot name="subtitle">{{ __('Edit Page') }}</x-slot>
            ...
            <form action="{{ route('admin.pages.update', $page) }}" method="POST">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        ...
                                        placeholder="{{ __('Enter page title') }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('excerpt') is-invalid @enderror" name="excerpt" rows="3"
                                        placeholder="{{ __('Enter page excerpt (optional)') }}">{{ old('excerpt', $page->excerpt) }}</textarea>
                                    <small
                                        class="text-muted">{{ __('Brief description of the page (max 500 characters)') }}</small>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="focus_keyword" value="{{ old('focus_keyword', $page->focus_keyword) }}"
                                        placeholder="{{ __('Enter focus keyword') }}" id="focus_keyword">
                                    <small class="text-muted">{{ __('Main keyword for this page') }}</small>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="meta_keywords" value="{{ old('meta_keywords', $page->meta_keywords) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        name="canonical_url" value="{{ old('canonical_url', $page->canonical_url) }}"
                                        placeholder="{{ __('Enter canonical URL (optional)') }}">
                                    <small class="text-muted">{{ __('Leave blank to use default page URL') }}</small>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('og_description') is-invalid @enderror" name="og_description" rows="2"
                                                        placeholder="{{ __('Leave blank to use meta description') }}" maxlength="200">{{ old('og_description', $page->og_description) }}</textarea>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('twitter_description') is-invalid @enderror" name="twitter_description"
                                                        rows="2" placeholder="{{ __('Leave blank to use meta description') }}" maxlength="200">{{ old('twitter_description', $page->twitter_description) }}</textarea>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('Page Settings') }}</h3>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('image') is-invalid @enderror"
                                        name="image" value="{{ old('image', $page->image) }}"
                                ...
                                @if (old('image', $page->image))
                                    <div class="mt-2">
                                        <img src="{{ old('image', $page->image) }}" alt="Preview"
                                ...
                                <div id="seo-preview" class="seo-preview">
                                    <div class="mb-2">
                                        <div class="text-primary" style="font-size: 14px; line-height: 1.3;"
                                            id="preview_url">
                                            {{ config('app.url') }}/pages/{{ old('slug', $page->slug) }}
                                        </div>
                                        <div class="fw-bold text-primary"
                                            style="font-size: 20px; line-height: 1.3; margin-top: 2px;"
                                            id="preview_title">
                                            {{ old('meta_title', $page->meta_title) ?: old('title', $page->title) }}
                                        </div>
                                        <div class="text-muted"
                                            style="font-size: 14px; line-height: 1.3; margin-top: 2px;"
                                            id="preview_description">
                                            {{ old('meta_description', $page->meta_description) ?: old('excerpt', $page->excerpt) ?: __('Enter meta description to see preview') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateSEOPreview() {
                    ...
                    const slug = document.querySelector('input[name="slug"]')?.value || '{{ $page->slug }}';
                    ...
                    if (previewUrl && slug) {
                        previewUrl.textContent = '{{ config('app.url') }}/pages/' + slug;
                    }
                }
