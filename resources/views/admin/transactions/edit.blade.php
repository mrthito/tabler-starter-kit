<x-app-layout :page="__('Edit Transaction')" layout="admin">

    <x-slot name="pretitle">{{ __('Transactions') }}</x-slot>
    <x-slot name="subtitle">{{ __('Edit Transaction') }}</x-slot>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" value="{{ old('title', $transaction->title) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="3"
                                        placeholder="{{ __('Enter transaction description') }}">{{ old('description', $transaction->description) }}</textarea>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                name="tax_type" value="{{ old('tax_type', $transaction->tax_type) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" min="0" max="100"
                                                ...
                                                name="tax_rate" value="{{ old('tax_rate', $transaction->tax_rate) }}"
                                                placeholder="0.00">
