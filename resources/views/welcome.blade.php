...
<head>
    ...
    <title>Laravel - Bootstrap 5 Version</title>

    <!-- Fonts -->
    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600" rel="stylesheet" />

    @vite(['resources/scss/admin.scss', 'resources/js/app.js', 'resources/scss/icons.scss'])
<style>
    ...
    <style>
        ...
        /* Custom Utilities to match Tailwind specifics */
        .max-w-custom {
            max-width: 335px;
            width: 100%;
        }
        ...
        [data-bs-theme="dark"] .main-card {
            box-shadow: 0 0 0 1px rgba(255, 250, 237, 0.18);
        }
        ...
        [data-bs-theme="dark"] .content-side {
        ...
        [data-bs-theme="dark"] .custom-list li::before {
            border-color: #3E3E3A;
        }
        ...
        [data-bs-theme="dark"] .dot-wrapper {
            background-color: var(--card-bg-dark);
        }
        ...
        [data-bs-theme="dark"] .deploy-btn {
            background-color: #eeeeec;
            border-color: #eeeeec;
            color: #1C1C1A;
        }

        [data-bs-theme="dark"] .deploy-btn:hover {
        ...
        [data-bs-theme="dark"] .laravel-logo {
            color: #F61500;
        }
        ...
        [data-bs-theme="dark"] .light-mode-svg {
            display: none;
        }

        [data-bs-theme="dark"] .dark-mode-svg {
            display: block;
        }
        ...
        [data-bs-theme="dark"] .shadow-overlay {
...
<body>
    ...
    <!-- Header -->
    <header class="w-100 max-w-custom mb-4 d-none d-lg-block">
    ...
    <!-- Main Content -->
    <div class="d-flex align-items-center justify-content-center w-100 flex-grow-1 fade-in-up">
        <main class="main-card max-w-custom">

            <!-- Left Side: Content -->
            <div class="content-side">
                <h1 class="h5 fw-medium mb-1">Let's get started</h1>
                <p class="mb-2 text-secondary" style="font-size: 13px; line-height: 20px;">
                ...
                <ul class="custom-list">
                    <li>
                        ...
                        <span style="font-size: 13px;">
                            Read the
                            <a href="https://laravel.com/docs" target="_blank" class="link-red ms-1">
                                Documentation
                    ...
                    <li>
                        ...
                        <span style="font-size: 13px;">
                            ...
                            <a href="https://laracasts.com" target="_blank" class="link-red ms-1">
                                Laracasts
                                <svg width="10" height="11" viewBox="0 0 10 11" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="ms-1">
                                    <path d="M7.70833 6.95834V2.79167H3.54167M2.5 8L7.5 3.00001" stroke="currentColor"
            ...
            <!-- Right Side: Visuals -->
            <div class="visual-side overflow-hidden">
                <!-- Laravel Logo SVG -->
                <svg class="laravel-logo fade-in-up" viewBox="0 0 438 104" fill="none"
                ...
                <!-- Background Graphic SVG (Light Mode) -->
                <svg class="bg-svg light-mode-svg fade-in-up delay-300" viewBox="0 0 440 376" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <path
                ...
                <!-- Background Graphic SVG (Dark Mode) -->
                <svg class="bg-svg dark-mode-svg fade-in-up delay-300" viewBox="0 0 440 376" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <path
                            d="M188.263 355.73L188.595 355.73C195.441 348.845 205.766 339.761 219.569 328.477C232.93 317.193 242.978 308.205 249.714 301.511C256.34 294.626 260.867 287.358 263.296 279.708C265.725 272.058 264.565 264.121 259.816 255.896C254.516 246.716 247.062 239.352 237.454 233.805C227.957 228.067 217.908 225.198 207.307 225.198C196.927 225.197 190.136 227.97 186.934 233.516C183.621 238.872 184.726 246.331 190.247 255.894L125.647 255.891C116.371 239.825 112.395 225.481 113.72 212.858C115.265 200.235 121.559 190.481 132.602 183.596C143.754 176.52 158.607 172.982 177.159 172.983C196.594 172.984 215.863 176.523 234.968 183.6C253.961 190.486 271.299 200.241 286.98 212.864C302.661 225.488 315.14 239.833 324.416 255.899C333.03 270.817 336.841 283.918 335.847 295.203C335.075 306.487 331.376 316.336 324.75 324.751C318.346 333.167 308.408 343.494 294.936 355.734L377.094 355.737L405.917 405.656L217.087 405.649L188.263 355.73Z"
